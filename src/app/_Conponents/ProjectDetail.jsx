...
const ProjectDetail = () => {
  ...
  return (
    <div className="">
      {
        dynamicRouteCOn && (
          <div className=' fixed  py-20 overflow-y-auto h-screen   flex items-center justify-center z-50 top-0 left-0 w-full    bg-webColor'>
           
           <div className= " text-gray-300 w-[85%]  p-11 relative bg-webColor rounded-lg shadow-[#1c1e22_2px_12px_18px_20px]  ">
